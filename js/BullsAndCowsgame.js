...
cmdUpdate.onclick = function () {
    var formattedTime = formatTime(last_time);
    location.href="php/updateScore.php?last_ctn="+ last_ctn+"&last_time="+ formattedTime;   
    // var xhr = new XMLHttpRequest();
    // xhr.open("POST", "PHP_ginnychen19.github.io/PHP/updateScore.php", true);
    // xhr.setRequestHeader("Content-Type", "application/json;charset=UTF-8");
    // xhr.send(JSON.stringify({ last_ctn: last_ctn, last_time: last_time }));
